...
export declare namespace ErrorResponse {
    type listEngines = void;
    type retrieveEngine = void;
...
export declare class Client<RequestOption> {
     ...
     */
    listEngines(option?: RequestOption): Promise<Response$listEngines$Status$200["application/json"]>;
    /**
     * @deprecated
     * Retrieves a model instance, providing basic information about it such as the owner and availability.
     */
    retrieveEngine(params: Params$retrieveEngine, option?: RequestOption): Promise<Response$retrieveEngine$Status$200["application/json"]>;
     ...
     */
    createSearch(params: Params$createSearch, option?: RequestOption): Promise<Response$createSearch$Status$200["application/json"]>;
     ...
     */
    createAnswer(params: Params$createAnswer, option?: RequestOption): Promise<Response$createAnswer$Status$200["application/json"]>;
    /**
     * @deprecated
     ...
     */
    createClassification(params: Params$createClassification, option?: RequestOption): Promise<Response$createClassification$Status$200["application/json"]>;
