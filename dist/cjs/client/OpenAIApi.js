...
const OpenAIApi = ({ apiKey, baseUrl, additionalHeaders, onResponse, organization, throttleManagerService, }) => {
    ...
    return new apiClient_js_1.Client(openAiApiFetch, baseUrl || "https://api.openai.com/v1");
};
